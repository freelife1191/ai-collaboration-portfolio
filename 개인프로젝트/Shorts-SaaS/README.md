...
- GitHub: https://github.com/freelife1191/shorts-saas

데모 페이지는 Supabase, Google Cloud 만료로 현재 제공되고 있지 않음

Claude Code에서 Spec-Kit 을 테스트 해보고자 개발을 시작했고 하루만에 개발 완료 
간단한 기능의 앱이지만 Spec-Kit을 사용해 큰 어려움 없이 개발이 완료되는 것을 경험함
